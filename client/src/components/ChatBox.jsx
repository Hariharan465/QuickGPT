...
const ChatBox = () => {
  ...
  return (
    <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
      ...
      <div ref={containerRef} className='flex-1 mb-5 overflow-y-scroll'>
        {messages.length === 0 && (
          <div className='h-full flex flex-col items-center justify-center gap-2 text-primary'>
            <img src={theme === 'dark' ? assets.logo_full : assets.logo_full_dark} className='w-full max-w-56 sm:max-w68' />
        ...
        {/* Three Dots Loading Animation */}
        {
          loading && <div className='loader flex items-center gap-1.5'>
            <div className='w-1.5 h-1.5 rounded-full bg-gray-500 data:bg-white animate-bounce'></div>
            <div className='w-1.5 h-1.5 rounded-full bg-gray-500 data:bg-white animate-bounce'></div>
            <div className='w-1.5 h-1.5 rounded-full bg-gray-500 data:bg-white animate-bounce'></div>
          </div>
        }
      ...
      {/* Prompt Input Box */}
      <form onSubmit={onsubmit} className='bg-primary/20 dark:bg-[#A3A29B]/ border border-primary dark:border-[#80609F]/30
      rounded-full w-full max-w-2xl p-2 pl-4 mx-auto flex gap-4 items-center'>
